...
export const translations = {
  zh: {
    ...
    retryInterval: "请求间隔",
    retryIntervalDesc: "每次API请求之间的等待时间",
    wordsPerPage: "每页显示单词数",
    ttsEngine: "发音引擎",
    ttsEdgeDesc: "效果好，但较慢",
    ttsWebspeechDesc: "实时，音质取决于设备和浏览器",
    backToHome: "返回主页",
    ...
    apiKeyInvalid: "API Key 无效或已过期，请检查设置中的 API Key",
    ...
    autoUpdate: "自动更新",
    autoUpdateDesc: "有新版本时自动下载并安装",
    autoUpdateNow: "自动更新",
    updateDownloaded: "下载完成，准备安装...",
    updateInstalling: "正在安装更新...",
    updateDone: "更新完成，请重启应用",
    updateRestartHint: "请关闭并重新打开应用以完成更新",
    retryUpdate: "重试",
    detectedPlatform: "检测到平台",
    currentVersion: "当前版本",
    latestVersion: "最新版本",
    saveFailed: "保存失败",
    saveFailedDesc: "设置保存失败，请重试",
    close: "关闭",
    downloadUpdate: "下载更新",
    releaseNotes: "更新说明"
  },
  en: {
    title: "Gualingo",
    subtitle: "",
    tagline: "Enter text, start your language learning journey",
    ...
    maskedHint: "Tap options below to fill in...",
    ...
    settings: "Settings",
    noApiKey: "Please fill in your API Key in Settings first",
    ...
    retryInterval: "Request Interval",
    retryIntervalDesc: "Wait time between API requests",
    wordsPerPage: "Words per page",
    ttsEngine: "TTS Engine",
    ttsEdgeDesc: "Better quality, but slower",
    ttsWebspeechDesc: "Real-time, quality depends on device and browser",
    ...
    apiKeyInvalid: "API Key is invalid or expired, please check your API Key in Settings",
    ...
    settingsNativeLang: "Native Language",
    ...
    autoUpdateNow: "Auto Update",
    updateDownloaded: "Download complete, preparing to install...",
    updateInstalling: "Installing update...",
    updateDone: "Update complete, please restart the app",
    updateRestartHint: "Please close and reopen the app to complete the update",
    retryUpdate: "Retry",
